(function (ext) {
    ...
    ext.disableVoiceTrigger = function (p1) {
        ...
        $.ajax({
            url: 'http://' + ip + port + '/?extension=education' + '&name=disableVoiceTrigger' + '&p1=' + p1,
            dataType: 'text',
            crossDomain: true,
            success: function (data) {
                console.log("success handler");
    ...
    ext.stopListening = function () {
        ...
        $.ajax({
            url: 'http://' + ip + port + '/?extension=education' + '&name=stopListening',
            dataType: 'text',
            crossDomain: true,
            success: function (data) {
                console.log("success handler");
    ...
    ext.detectPerson = function (p1) {
        ...
        $.ajax({
            url: 'http://' + ip + port + '/?extension=education' + '&name=detectPerson' + '&p1=' + p1,
            dataType: 'text',
            crossDomain: true,
            success: function (data) {
                console.log("success handler");
    ...
    ext.when_detected_person_and_run = function () {

        var valueIndex_detected_person = -1;
    ...
    ext.faceToPerson = function (p1) {
        ...
        $.ajax({
            url: 'http://' + ip + port + '/?extension=education' + '&name=faceToPerson' + '&p1=' + p1,
            dataType: 'text',
            crossDomain: true,
            success: function (data) {
                console.log("success handler");
    ...
    var TRANSLATIONS = {
        us: {
            ...
            disableVoiceTrigger: '%m.MenuDisableVoiceTrigger listening hey, Zenbo',
            stopListening: 'Stop listening',
            detectPerson: '%m.detectPersonItems detected person(s)',
            when_detected_person_and_run: 'when detected person(s)',
            faceToPerson: 'face to %m.faceToPersonItems person',
        ...
        tw: {
            ...
            followLineRun: '%m.MenuFollowLineStartStop 循線前進',
            followLineConfig: '設定循線時踩到 %m.MenuFollowLineColorPattern 色, 做 %m.MenuFollowLineBehavior ',
            startReadColor: '%m.MenuReadColor 感測踩到的顏色',
            when_read_color_and_run: '當 Zenbo 感測踩到顏色 %m.color_type',
            disableVoiceTrigger: '%m.MenuDisableVoiceTrigger 聽 hey, Zenbo',
            stopListening: '停止聽話',
            detectPerson: ' %m.detectPersonItems 偵測人',
            when_detected_person_and_run: '當偵測到人',
            faceToPerson: '面向 %m.faceToPersonItems 人',
    ...
    var descriptor = {
        blocks: [
            ...
            ['', translate.disableVoiceTrigger, 'disableVoiceTrigger', translate.MenuDisableVoiceTrigger[0]],
            ['', translate.stopListening, 'stopListening'],
            ['', translate.detectPerson, 'detectPerson', translate.detectPersonItems[0]],
            ['h', translate.when_detected_person_and_run, 'when_detected_person_and_run'],
            ['', translate.faceToPerson, 'faceToPerson', translate.faceToPersonItems[0]],
        ],
        menus: {
