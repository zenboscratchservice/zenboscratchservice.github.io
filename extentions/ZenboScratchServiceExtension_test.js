(function (ext) {
    ...
    var descriptor = {
        blocks: [
            ...
            ['', 'IP %s: %m.playVideosInYoutubeItems播放Youtube網址: %s', 'playVideosInYoutube', "192.168.0.1",'https://www.youtube.com/watch?v=09R8_2nJtjg', '開始'],
            ['', 'IP %s: %m.displayUrlPicturesItems瀏覽線上圖片: %s', 'displayUrlPictures', "192.168.0.1",'http://seacrestwolfpreserve.org/site/templates/images/home-slider-wolf-face-01.jpg', '開始'],
            ['', 'IP %s: %m.playUrlMusicItems播放線上音樂: %s', 'playUrlMusic', "192.168.0.1",'http://www.abstractpath.com/files/audiosamples/sample.mp3', '開始'],
        ],
        menus: {
