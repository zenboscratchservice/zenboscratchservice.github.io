(function (ext) {
    ...
    var descriptor = {
        blocks: [
            ...
            // ZenboJr only ['', translate.followLineRun, 'followLineRun', translate.MenuFollowLineStartStop[0]],
            // ZenboJr only ['', translate.followLineConfig, 'followLineConfig', translate.MenuFollowLineColorPattern[0], translate.MenuFollowLineBehavior[0]],
            // ZenboJr only ['', translate.startReadColor, 'startReadColor',  translate.MenuReadColor[0]],
            // ZenboJr only ['h', translate.when_read_color_and_run, 'when_read_color_and_run', translate.color_type[0]],
