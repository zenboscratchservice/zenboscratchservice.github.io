(function (ext) {
    ...
    var TRANSLATIONS = {
        ...
        tw: {
            ...
            followLineRun: 'IP %s %m.MenuFollowLineStartStop 循線前進',
            followLineConfig: 'IP %s 設定循線時踩到 %m.MenuFollowLineColorPattern 色, 做 %m.MenuFollowLineBehavior ',
            startReadColor: 'IP %s %m.MenuReadColor 感測踩到的顏色',
            when_read_color_and_run: '當 Zenbo IP %s 感測踩到顏色 %m.color_type',
    ...
    var descriptor = {
        blocks: [
            ...
            ['w', translate.headMovement, 'headMovement', "192.168.0.1", translate.headLRDirection[0], translate.headLRDegree[0], translate.headUDDirection[0], translate.headUDDegree[1]],
            ['', translate.Head_movement, 'Head_movement', "192.168.0.1", translate.head_direction[2], translate.head_degree[1]],
            ...
            ['', translate.followLineRun, 'followLineRun', "192.168.0.1",  translate.MenuFollowLineStartStop[0]],
            ['', translate.followLineConfig, 'followLineConfig', "192.168.0.1",  translate.MenuFollowLineColorPattern[0], translate.MenuFollowLineBehavior[0]],
            ['', translate.startReadColor, 'startReadColor', "192.168.0.1", translate.MenuReadColor[0]],
            ['h', translate.when_read_color_and_run, 'when_read_color_and_run',  "192.168.0.1", translate.color_type[0]],
            ['', translate.disableVoiceTrigger, 'disableVoiceTrigger', "192.168.0.1", translate.MenuDisableVoiceTrigger[0]],
            ['', translate.stopListening, 'stopListening', "192.168.0.1"],
            ['', translate.detectPerson, 'detectPerson', "192.168.0.1", translate.detectPersonItems[0]],
            ['h', translate.when_detected_person_and_run, 'when_detected_person_and_run', "192.168.0.1"],
            ['', translate.faceToPerson, 'faceToPerson', "192.168.0.1", translate.faceToPersonItems[0]],
        ],
        menus: {
