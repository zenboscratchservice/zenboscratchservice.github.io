    ...
    ext.Setting_targetIP = function (onlyIPAddress, callback) {
        ...
        console.log("ip: "+ ip + "onlyIPAddress: "+ onlyIPAddress);
         ...
         if ( setupFlag_init == true) {
               ...
               sentence_4_flag: false, sentence_5_flag: false, otherSentence_flag: false,  number_flag: false, touch_head_flag: false, get_sentences_flag: true,
               recursionFlag: true, color_sensor_flag_black: false, color_sensor_flag_blue: false, color_sensor_flag_green: false, color_sensor_flag_red: false,
               color_sensor_flag_white: false, olor_sensor_flag_yellow: false} );
...
function showAlertMessage()
{
    ...
    ext.when_read_color_and_run = function(p1) {
   ...
   ext.Add_and_update_sentence_number = function () {
         ...
         if ( setupFlag_init_3 == true) {
               ...
               sentence_4_flag: false, sentence_5_flag: false, otherSentence_flag: false,  number_flag: false, touch_head_flag: false, get_sentences_flag: true,
               recursionFlag: true, color_sensor_flag_black: false, color_sensor_flag_blue: false, color_sensor_flag_green: false, color_sensor_flag_red: false,
               color_sensor_flag_white: false, color_sensor_flag_yellow: false} );
               console.log("add new device IP and its flags");
   ...
   ext.stopWheelLight = function (p1) {
    ...
    ext.followLineRun = function (p1){
      ...
      $.ajax({
          url: 'http://' + ip + port + '/?extension=education' + '&name=followLineRun' + '&p1=' + p1 ,
          dataType: 'text',
          crossDomain: true,
          success: function (data) {
            console.log("success handler");
    ...
    ext.followLineConfig = function (p1, p2){
      for(var i = 0; i < translate.MenuFollowLineStartStop.length; i++){
        if ( p1 == translate.MenuFollowLineStartStop[i]) {
          p1 = TRANSLATIONS.us.MenuFollowLineStartStop[i];
        }
      ...
      $.ajax({
          url: 'http://' + ip + port + '/?extension=education' + '&name=followLineConfig' + '&p1=' + p1 + '&p2=' + p2,
          dataType: 'text',
          crossDomain: true,
          success: function (data) {
            console.log("success handler");
    ...
    ext.startReadColor = function (p1){
      for(var i = 0; i < translate.MenuReadColor.length; i++){
        ...
        $.ajax({
            url: 'http://' + ip + port + '/?extension=education' + '&name=startReadColor' + '&p1=' + p1 ,
            dataType: 'text',
            crossDomain: true,
            success: function (data) {
              console.log("success handler");
    ...
    var TRANSLATIONS = {
        us: {
            ...
            followLineRun: '%m.MenuFollowLineStartStop start follow line',
            followLineConfig: 'update follow line behavior, when see %m.MenuFollowLineColorPattern do %m.MenuFollowLineBehavior',
            startReadColor: '%m.MenuReadColor read color',
            when_read_color_and_run: 'when Zenbo read color %m.color_type',
	          head_direction: ["top", "bottom"],
            head_degree: ["0", "10", "30", "50"],
            ...
            startWheelLightEffect: ["static", "strobing", "breath", "color cycle", "forward rainbow", "backward rainbow", "breath rainbow", "forward comet", "backward comet", "forward rainbow comet", "backward rainbow comet", "forward moving flash", "backward moving flash", "forward flash dash", "backward flash dash", "forward rainbow wave", "backward rainbow wave", "glowing yoyo", "starry night", "wave"],
            ...
            MenuFollowLineBehavior: ["CROSSROAD_LEFT", "CROSSROAD_RIGHT", "CURVE", "FORKED_LEFT", "FORKED_RIGHT", "SPEED_LEVEL_SLOW", "SPEED_LEVEL_NORMAL", "SPEED_LEVEL_FAST", "TERMINATE", "U_TURN"],
	...
	tw: {
            ...
            followLineRun: '%m.MenuFollowLineStartStop 沿線行走',
            followLineConfig: '設定沿線行走行為, 當看到 %m.MenuFollowLineColorPattern 做 %m.MenuFollowLineBehavior ',
            startReadColor: '%m.MenuReadColor 讀取顏色',
            when_read_color_and_run: '當 Zenbo 讀取到顏色 %m.color_type',
            head_direction: ["上", "下"],
            head_degree: ["0", "10", "30", "50"],
            ...
            startWheelLightEffect: ["恆亮","Strobing","呼吸","ColorCycle","ForwardRainbow","BackwardRainbow","BreathRainbow","ForwardComet","BackwardComet","ForwardRainbowComet","BackwardRainbowComet","ForwardMovingFlash","BackwardMovingFlash","ForwardFlashDash","backwardFlashDash","ForwardRainbowWave","BackwardRainbowWave","GlowingYoYo","StarryNight","Wave"],
    ...
    var descriptor = {
        blocks: [
            ...
            ['', translate.followLineRun, 'followLineRun', translate.MenuFollowLineStartStop[0]],
            ['', translate.followLineConfig, 'followLineConfig', translate.MenuFollowLineColorPattern[0], translate.MenuFollowLineBehavior[0]],
            ['', translate.startReadColor, 'startReadColor',  translate.MenuReadColor[0]],
            ['h', translate.when_read_color_and_run, 'when_read_color_and_run', translate.color_type[0]],
        ],
        menus: {
            ...
            "MenuFollowLineStartStop": translate.MenuFollowLineStartStop,
            "MenuFollowLineColorPattern": translate.MenuFollowLineColorPattern,
            "MenuFollowLineBehavior": translate.MenuFollowLineBehavior,
            "color_type": translate.color_type,
            "MenuReadColor": translate.MenuReadColor,
        },
