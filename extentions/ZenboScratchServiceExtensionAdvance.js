(function (ext) {
    ...
    var descriptor = {
        blocks: [
            ...
            // ZenboJr only ['', translate.followLineRun, 'followLineRun', "192.168.0.1",  translate.MenuFollowLineStartStop[0]],
            // ZenboJr only ['', translate.followLineConfig, 'followLineConfig', "192.168.0.1",  translate.MenuFollowLineColorPattern[0], translate.MenuFollowLineBehavior[0]],
            // ZenboJr only ['', translate.startReadColor, 'startReadColor', "192.168.0.1", translate.MenuReadColor[0]],
            // ZenboJr only ['h', translate.when_read_color_and_run, 'when_read_color_and_run',  "192.168.0.1", translate.color_type[0]],
